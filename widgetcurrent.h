...
public:
    explicit WidgetCurrent( int comStart = 1, QString name = "name", QString date = "date", QString pic_str = ":/picture/P1.jpg", int age = 10, int number = 1, QWidget *parent = nullptr );
    ~WidgetCurrent();
