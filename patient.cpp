...
Patient::Patient( int comStart, QString name, QString date, QString pic_str, int age, int number, QWidget *parent ) : QWidget(parent)
{
    patientForm = new PatientForm( name, date, pic_str, age, number, this );
    patientForm->setObjectName("病人选择界面");
    widgetCurrent = new WidgetCurrent( comStart, name, date, pic_str, age, number );
